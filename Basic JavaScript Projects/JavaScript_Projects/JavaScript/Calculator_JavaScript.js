...
const Calculator = {
    ...
    Display_Value: '0',
    //this will hold the first operand for an expressions, we set it ot null for now
    First_Operand: null,
...
//this modifies values each time a butotn is clicked
...
function Input_Decimal(dot) {
    //thsi ensures that accidental clicking of the decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand ==null) {
        ...
        //in the Perform_Caclulation object and the function that matches the
        //operator is executed
        let result = Perform_Calculation[operator] (Value_Now, Value_of_Input);
        //here we add a fixed amount of nubmers after the decimal
...
//this funciotn updates the screen with the contents of Display_Value
